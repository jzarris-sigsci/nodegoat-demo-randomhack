...
func (p *program) Start(s service.Service) error {
	...
	auth = Attack{name: "Auth", method: "POST", maxNap: 240, minNap: 0, pause: 2, maxRequests: 100,
		minRequests: 10, url: fmt.Sprintf("http://%s/login?%s", target, "userName=admin&password=taco"),
