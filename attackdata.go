...
var (
	...
	probeurls = []string{
		"index.asp?page=..%2F..%2F..%2F..%2F..%2Fetc%2Fpasswd",
		"shell.php",
		"ampache/login.php",
		...
		".git/info/refs",
		"/auth/auth_phpbb/phpbb_root_path=http://cirt.net/rfiinc.txt",
		"sid=XXXXXXXXXXXXXXXXXXXXXXXXXXXX&shopid=http://cirt.net/rfiinc.txt",
	...
	crawlerpaths = []string{"10001.php",
		...
		"10098.php",
		"10099.php"}
	crawlerips = []string{"217.160.180.106",
		"178.33.236.178",
		"173.254.28.22",
		"74.208.126.189",
		"197.231.221.211",
	...
	urls = []string{"http://sigscidemo.com",
		"http://www.sigscidemo.com",
		"http://wp.sigscidemo.com",
		"http://sigscidemo.is",
		"http://wp.sigscidemo.is",
		"http://facebook.com",
		"http://linkedin.com",
		"http://googleadservices.com",
		"http://paypal.com",
		"http://s3.amazonaws.com",
		"http://sigscidemo.zendesk.com",
		"http://sigscidemo-a.akamaihd.net",
		"http://d2pj2twnjx3fya.cloudfront.net",
		"http://localhost",
		"http://anapp.me/AbC",
		"http://taps.io/TaCoPiZZa",
		"http://attendee.gotowebinar.com/rt/000111222333",
		"http://HealthRoad2000.com",
		"http://OldBookworm.com",
		"http://getdonner.com",
		"http://covertcops.com",
		"http://hiphopnations.com",
		"http://enditallnow.com",
		"http://extremetruth.net",
		"http://snakeboy.net",
		"http://b-frendz.com",
		"http://scumwatch.com",
		"http://toomail.net",
		"http://gbc.bz",
		"http://noexecutions.org",
		"http://manhattanhears.org",
		"http://YouLenz.com",
		"http://zeroenergyfootprint.com",
		"http://searchling.org",
		"http://unraptured.com",
		"http://paparazziberry.com",
		"http://flashposse.net",
		"http://citysmear.com",
		"http://therealgore.com",
		"http://urbanexcitement.com",
		"http://127.0.0.1:8080",
